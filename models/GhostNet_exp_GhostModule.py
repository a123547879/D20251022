...
class GhostBottleneck(nn.Module):
    ...
    def __init__(self, in_ch, mid_ch, out_ch, stride= 1):
        ...
        self.ghost1  = nn.Conv2d(in_ch, mid_ch, kernel_size= 1, stride= 1, padding= 0, bias= False)
        ...
        self.ghost2 = nn.Conv2d(mid_ch, out_ch, kernel_size= 1, stride= 1, padding= 0, bias= False)
